                    ...
                    <div className="flex items-center justify-center gap-4">
                        {[
                            ...
                            <div key={s.id} className="flex items-center">
                                <div className={`flex items-center gap-2 ${step === s.id ? "text-purple-700" :
                                        ["shipping", "payment", "review"].indexOf(step) > index ? "text-green-600" : "text-gray-400"
                                    }`}>
                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${step === s.id ? "bg-purple-700 text-white" :
