                        ...
                        <div className="flex gap-4 mb-8">
                            {
                                isInCart ? <>
                                    <Link
                                        href="/cart"
                                        className={`flex-1 bg-green-600 text-white text-center py-4 text-sm font-medium cursor-pointer`}
                                    >
                                        View Cart
                                    </Link>
                                </> : <>
                                    <button
                                        ...
                                        className={`flex-1 bg-logo text-white text-center py-4 text-sm font-medium cursor-pointer`}
                                    >
                                        ADD TO BAG
                                    </button>
                                </>
                            ...
                            <button
                                ...
                                className={`w-14 h-14 border flex items-center justify-center transition-colors ${inWishlist ? "bg-pink-50 border-pink-300" : "border-gray-300 hover:border-gray-400"
                                    }`}
                            >
